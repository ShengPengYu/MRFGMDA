...
if __name__ == '__main__':
    ...
    #settings = settings_reader.read("settings/distmult.exp")
    #settings = settings_reader.read("settings/gcn_basis.exp")
    print(settings)
    ...
    #tf.train.Saver(model.session, dataset + "/model")

    tf.train.Saver().save(sess=model.session, save_path=dataset + "/model")
