...
from shared import algorithms as shared_algorithms
from tensorflow_backend import algorithms as tensorflow_algorithms
from theano_backend import algorithms as theano_algorithms
